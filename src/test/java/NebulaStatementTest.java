...
public class NebulaStatementTest {
    ...
    public void executeQueryWithNullResponseValueTest() throws SQLException {
        ...
        String queryTestNode = "match (v:testNode) return id(v) as id, v.notExist as notExist ORDER BY id ASC";
        ResultSet resultSet = statement.executeQuery(queryTestNode);
    ...
    public void executeUpdateTest() throws SQLException {
        ...
        String queryTestNode = "MATCH (v:testNode) return id(v) AS id, v.theString AS theString, v.theInt AS theInt ORDER BY id ASC";
