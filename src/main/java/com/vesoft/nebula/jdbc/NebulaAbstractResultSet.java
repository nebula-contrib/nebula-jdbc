...
public abstract class NebulaAbstractResultSet implements ResultSet {
    ...
    public NebulaAbstractResultSet(com.vesoft.nebula.client.graph.data.ResultSet nativeNebulaResultSet) {
        this.nativeNebulaResultSet = nativeNebulaResultSet;
    }
